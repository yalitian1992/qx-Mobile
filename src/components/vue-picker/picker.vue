  ...
  methods: {
        ...
        if (defaultData[0] && defaultData[0].value) {
          ...
          for (var i = 0, len = this.pData1.length; i < len; i++) {
            if (this.pData1[i].value == defaultData[0].value) {
              pos1 = -(i * 2);
              this.selectData.pData2 && (this.pData2 = [].concat(
                this.selectData["pData2"][defaultData[0].value]
              ));
              break;
            }
          }
        ...
        if (defaultData[1] && defaultData[1].value) {
          for (var i = 0, len = this.pData2.length; i < len; i++) {
            if (this.pData2[i].value == defaultData[1].value) {
              pos2 = -(i * 2);
              this.selectData.pData3 && (this.pData3 = [].concat(
                this.selectData["pData3"][defaultData[1].value]
              ));
              break;
            }
          }
    ...
    resetData2(endVal) {
      this.$nextTick(() => {
        ...
        if (
          this.pData1[endVal] &&
          this.selectData.pData2[this.pData1[endVal].value]
        ) {
